<template>
  <div>
    ...
    <div class="page-operation-bottons">
      <el-row>
        <el-button v-if="checkPermission(['tms.settlement.collect.invexport']) || checkPermission(['tms.settlement.pay.invexport']) " class="port-btn" icon="el-icon-download" @click="exportList">导出</el-button>
        <el-button v-if="checkPermission(['tms.settlement.collect.genInvoice'])|| checkPermission(['tms.settlement.pay.genInvoice'])" class="change-btn" icon="fa fa-upload" @click="addInvocie"> 生成发票</el-button>
