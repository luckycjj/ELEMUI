<template>
  <div>
    ...
    <div class="page-operation-bottons">
      <el-row>
        <el-button v-if="checkPermission(['tms.settlement.pay.create'])" class="change-btn" icon="el-icon-plus" @click="addDialog">新增对账单</el-button>
...
import { checkPayList, choosepkbala } from '@/api/settlement'
...
export default {
  name: 'PayNoaccount',
  components: { Pagination, SoaDialog, invoice },
  directives: { waves },
  data() {
    return {
      source: 1,
